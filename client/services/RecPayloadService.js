...
exports.RecPayloadService = void 0;
const OpenAPI_1 = require("../core/OpenAPI");
const request_1 = require("../core/request");
class RecPayloadService {
    /**
     ...
     * @throws ApiError
     */
    static getRec(recUrlAccessToken) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            url: '/rec/{recUrlAccessToken}',
            path: {
                'recUrlAccessToken': recUrlAccessToken,
            },
            errors: {
...
exports.RecPayloadService = RecPayloadService;
